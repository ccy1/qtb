...
public class ArcProgress extends ProgressBar {
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRadius = attributes.getDimensionPixelOffset(R.styleable.ArcProgress_arc_radius,DEFAULT_mRadius);
...
//        Log.e("DEMO","right == "+mArcRectf.right+"   mRadius == "+mRadius*2);
    ...
    public int getmUnmProgressColor() {
        return mUnmProgressColor;
    }

    public void setmUnmProgressColor(int mUnmProgressColor) {
        this.mUnmProgressColor = mUnmProgressColor;
        invalidate();
    }
}
